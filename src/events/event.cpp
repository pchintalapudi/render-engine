...
js::Event::Event(bool bubbles, bool cancelable, bool composed, EventTarget &target,
                 std::vector<DOMString> types, bool trusted)
        : bubbles(bubbles), cancelable(cancelable), composed(composed),
          defaultPrevented(false), eventPhase(EventPhase::CAPTURING_PHASE), originalTarget(target),
